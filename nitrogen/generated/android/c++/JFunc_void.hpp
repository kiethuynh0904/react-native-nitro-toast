...
namespace margelo::nitro::nitrotoast {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrotoast/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrotoast/Func_void_cxx;";
